...
export function ResultsDisplay({ results, domain }: ResultsDisplayProps) {
  ...
  return (
    <div className="grid lg:grid-cols-12 gap-3 lg:gap-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
      {/* Right Column - ECH Parameters (5 columns) - Move to top on mobile */}
      <div className="lg:col-span-5 order-1 lg:order-1 mt-0 lg:mt-0">
        {hasEchData ? (
                  ...
                  <>
                    ...
                    <details className="group">
                      <summary className="cursor-pointer list-none">
                        <div className="flex items-center justify-between bg-background/50 p-1.5 lg:p-2 rounded border hover:bg-background/70 transition-colors">
                          <Label className="text-[9px] lg:text-[10px] text-muted-foreground uppercase cursor-pointer">Raw ECHConfig</Label>
                          <span className="text-[9px] lg:text-[10px] text-muted-foreground group-open:rotate-180 transition-transform">▼</span>
                        </div>
                      </summary>
                      <div className="bg-background/50 p-1.5 lg:p-2 rounded border font-mono text-[8px] lg:text-[9px] break-all max-h-16 lg:max-h-20 overflow-y-auto mt-1 lg:mt-2">
      ...
      <div className="lg:col-span-7 space-y-3 lg:space-y-4 order-2 lg:order-2">
        {/* Header Card */}
              ...
              <TableBody>
                {results.map((res, i) => (
                  <React.Fragment key={i}>
                    ...
                    {expandedRow === i && (
                      <TableRow>
                        <TableCell colSpan={4} className="bg-muted/5 p-2 lg:p-3">
