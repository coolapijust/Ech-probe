        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            {PRESET_RESOLVERS.map((res) => (
              <div key={res} className="flex items-center space-x-3 p-3 rounded-lg border bg-background/30 hover:bg-background/50 transition-colors cursor-pointer" onClick={() => togglePreset(res)}>
                <Checkbox checked={selectedPresets.includes(res)} />
