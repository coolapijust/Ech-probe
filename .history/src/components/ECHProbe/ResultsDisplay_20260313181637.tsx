                ...
                (() => {
                  ...
                  return (
                    <div className="space-y-6">
                      ...
                      <div className="space-y-1.5">
                        <Label className="text-xs text-muted-foreground uppercase tracking-wider">Keys Detected</Label>
                        <div className="bg-background/50 p-3 rounded-lg border font-mono text-xs break-all text-accent/80">
                          {details.keys[0]}
                        </div>
                      </div>
                      <div className="space-y-1.5">
                        <Label className="text-xs text-muted-foreground uppercase tracking-wider">Raw ECHConfig</Label>
                        <div className="bg-background/50 p-3 rounded-lg border font-mono text-[10px] break-all max-h-32 overflow-y-auto">
