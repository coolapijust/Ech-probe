...
export function ResultsDisplay({ results, domain }: ResultsDisplayProps) {
  ...
  return (
    <div className="grid lg:grid-cols-12 gap-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
        ...
        <Card className="bg-card border-border">
          <CardContent className="p-4">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
              <div>
                <h2 className="text-lg font-bold text-accent">{t.analysisFor} {domain}</h2>
