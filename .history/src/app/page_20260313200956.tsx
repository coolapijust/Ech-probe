    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 p-6">
        ...
        <div className="grid lg:grid-cols-12 gap-6">
          {/* Left Column - Form (8 columns, majority) */}
          <div className="lg:col-span-8">
            <DomainForm onAnalyze={handleAnalyze} isLoading={isAnalyzing} />
          </div>

          {/* Right Column - Features vertical stack (4 columns) */}
...
function FeatureCard({ icon, title, description }: { icon: React.ReactNode; title: string; description: string }) {
  return (
    <div className="flex items-start gap-4 p-4 rounded-xl bg-card border border-border/50 hover:border-accent/30 transition-colors">
