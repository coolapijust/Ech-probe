  ...
  try {
    ...
    return new Promise((resolve) => {
        ...
        const socket = tls.connect(tlsOptions, () => {
          ...
          console.log(`[HRR] Protocol: ${protocol}, Cipher: ${cipher?.name}`);
          console.log(`[HRR] ECH accepted - server may not support ECH or ECH was not negotiated`);
          socket.end();
          ...
          resolve({
            ...
            errorMessage: 'Server accepted invalid ECH config (unexpected). Server may not support ECH.',
          });
        });
